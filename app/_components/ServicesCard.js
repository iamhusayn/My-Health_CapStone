...
const ServicesCard = ({ icon, tittle}) => {
  return (
    <div className='group flex flex-col items-center text-center gap-2 w-full lg:w-1/3 p-5 rounded-md cursor-pointe shadow-lgr lg:hover-translate-y-6 transition duration-300 ease-in-out'>
      ...
      <div className='cursor-pointer hover:text-green-800 transition duration-300 ease-in-out'>
        <HeaderBtn
