...
import Footer2 from "@/app/_components/Footer2";
...
export function ValuePage() {
  return (
    <>
      ...
      {/* <section className="bg-slate-950 md:h-[400px] flex flex-col py-8 mb-1 mt-40 pt-14 items-center gap-8">
      ...
      <Footer2
        ...
        paragraph={
          "Our values are the foundation of our company, and they guide us in building meaningful relationships with our clients, partners, and community."
        }
        btnTag={"Get In Touch"}
      />
    </>
